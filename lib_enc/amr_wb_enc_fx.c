...
)
{
    ...
    test();
    IF( L_sub(st->total_brate_fx,ACELP_23k85) == 0 && L_sub(st->last_core_brate_fx,ACELP_23k85) != 0 )
    {
    ...
    {
        move16();
        IF( sub(st->last_L_frame_fx,L_FRAME32k) == 0 )
        {
            /* (float)12800/(float)32000; */
            tmp = 13107;
        }
        ELSE IF( sub(st->last_L_frame_fx,512) == 0 )
        {
